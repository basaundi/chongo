...
(function() {
  var Collection, Connection, Cursor, Database, Document, Namespace, ObjectId, Pongo, Query, Update, k, s1, s2, u1, v, _ref, _ref1, _ref2,
  ...
  u1 = {
    $set: function(upd, old) {
      return upd;
    }
  };

  Update = function(op, update, data) {
    var du, s, x, _i, _len, _ref1, _results;
    _results = [];
    for (k in update) {
      v = update[k];
      x = data;
