...
(function() {
  var Collection, Connection, Cursor, Database, Document, Namespace, ObjectId, Pongo, _ref, _ref1,
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };

  Cursor = (function() {
    function Cursor(col, index, spec) {
      this.col = col;
      this.index = index;
      this.spec = spec;
      this.doc = null;
  ...
  */
  ...
  Collection = (function(_super) {
    ...
    Collection.prototype.find = function() {
      return new Cursor(this, this.data.sub);
    };
    ...
    Collection.prototype.insert = function(doc) {
      ...
      doc = new Document(this, new ObjectId(), doc);
      doc.store();
  ...
  Connection = (function() {
    ...
    Connection.prototype.get = function(reg) {
      ...
      return JSON.parse(this.store.getItem(this.ns + reg));
    };
