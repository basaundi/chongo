...
(function() {
  var Chongo, Collection, Compare, Connection, Cursor, Database, Document, Namespace, ObjectId, Query, Update, cmp, cmp_type, deep_cmp, dotDel, dotGet, dotSet, k, s1, s2, simple_cmp, type_order, u1, v, zero, _ref, _ref1, _ref2,
  ...
  Collection = (function(_super) {
    ...
    Collection.prototype.findOne = function(query) {
      ...
      if (typeof query === "string") {
        return new Document(this, query).data;
      }
