...
(function() {
  var Chongo, Collection, Compare, Connection, Cursor, Database, Document, Namespace, ObjectId, Projection, Query, Update, cmp, cmp_type, deep_cmp, dotDel, dotGet, dotSet, k, s1, s2, simple_cmp, type_order, u1, v, zero, _ref, _ref1, _ref2,
  ...
  deep_cmp = function(a, b) {
    return simple_cmp(JSON.stringify(a), JSON.stringify(b));
  };

  cmp_type = [null, zero, zero, simple_cmp, simple_cmp, deep_cmp, deep_cmp, simple_cmp, simple_cmp, simple_cmp, simple_cmp, simple_cmp, zero];
  ...
  u1 = {
    ...
    $push: function(d, k, upd) {
      ...
      if (upd.$each != null) {
        ...
        return l.splice(0, l.length + upd.$slice);
      } else {
        return l.push(upd);
      }
    }
  ...
  Cursor = (function() {
    function Cursor(col, index, query, projection) {
      this.col = col;
      this.index = index;
      this.query = query;
    ...
    Cursor.prototype.load = function() {
      this.started = true;
      this.match = Query(this.query);
      return this.project = this.projection != null ? Projection(this.projection) : function(x) {
        return x;
      };
    };
  ...
  Collection = (function(_super) {
    ...
    Collection.prototype.find = function(criteria, projection) {
      return new Cursor(this, this.data.sub, criteria, projection);
    };

    Collection.prototype.findOne = function(criteria, projection) {
      var cur;
      cur = new Cursor(this, this.data.sub, criteria, projection);
      try {
        return cur.next();
      } catch (_error) {
        return null;
    ...
    Collection.prototype.col = function(col) {
    ...
    Collection.prototype.drop = Collection.prototype.destroy;
  ...
  Database = (function(_super) {
    ...
    Database.prototype.col = function(col) {
      var c;
      c = Collection.prototype.col.call(this, col);
      this.data.sub.push(col);
      return c;
    };
  ...
  Connection = (function() {
    function Connection(store) {
      this.store = store;
      this.ns = '$';
      this.data = this.get('.local.system.chongo');
      if (this.data == null) {
        this.data = {};
        this.data.hostname = ObjectId.hostname;
        this.set('.local.system.chongo', this.data);
      }
    }
